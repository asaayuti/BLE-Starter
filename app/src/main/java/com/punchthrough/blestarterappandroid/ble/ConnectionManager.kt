...
import com.punchthrough.blestarterappandroid.ENABLE_BLUETOOTH_REQUEST_CODE
                ...
                if (ActivityCompat.checkSelfPermission(
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                        ActivityCompat.requestPermissions(
                            context as Activity, // Change "this" to the appropriate Activity reference
                            arrayOf(Manifest.permission.BLUETOOTH_CONNECT),
                            ENABLE_BLUETOOTH_REQUEST_CODE
                        )
                    } else {
                        // Handle the case for versions lower than Android S
                        // You can show a message to the user indicating that the permission is required
